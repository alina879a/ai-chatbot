...
def main():
    load_dotenv()
    st.set_page_config(page_title="Chat with multiple manuals",
                       page_icon=":books:")
    ...
    st.header("Upload SweetRobo manual here:")
    user_question = st.text_input("Ask a question about your machine:")
    if user_question:
